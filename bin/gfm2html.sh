...
# Github Styles Sheets are included in the output
#
# The MIT License (MIT)
...
#
# gfm2html input > output
#   * input: is a filename (the input is a Github Flavored Markdown (GFM) syntax document)
#   * output: is a output filename (the output is a HTML syntax document)
...
/\\\n}
    ...
    html=$(cat <<'WRAPPER'
<!DOCTYPE HTML>
<!--Converted by GFM2HTML (https://gist.github.com/4133083)-->
<html lang="en-US">
<head>
    <meta charset="UTF-8">
    <title></title>
...
WRAPPER
    ...
    echo "$html${result}</div></body></html>"
